...
2. **Pull state from these sources (in order):**
   - Any plan files referenced this session.
   ...
   - Memory files written or updated (`Memory/current-state.md` if this project has a memory system).
...
- Writing the summary to any file. This is chat-only by design.
